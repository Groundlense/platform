...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Payment reference ID returned by Razorpay' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({
        description: 'Razorpay checkout signature (HMAC-SHA256 of order_id|payment_id); verified server-side',
    }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
