...
export declare class AuthService {
    ...
    constructor(usersService: UsersService, jwtService: JwtService, db: DatabaseService, activityLogsService: ActivityLogsService, notificationsService: NotificationsService);
    private hashToken;
