...
export default function DashboardClient({ projects, summary, user }: DashboardClientProps) {
      ...
      <div className="flex-1 overflow-y-auto" style={{ padding: "24px 28px" }}>
        ...
        {projects.length === 0 && (
          <div className="text-center py-16">
            ...
            <div className="text-[12px] text-text-ter leading-relaxed max-w-[300px] mx-auto">Create your first project to start managing borings, teams, and IS 1892 reports.</div>
          </div>
        )}
      </div>
